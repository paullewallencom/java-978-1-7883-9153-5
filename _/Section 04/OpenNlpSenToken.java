	...
	public static void main(String[] args){
		...
		try {
			openNlp.useOpenNlp("My name is Rushdi Shams. "
					...
					+ "but I am a bit shy to use it.", "C:/nl-sent.bin", "sentence");
			openNlp.useOpenNlp("\"Let's get this vis-a-vis\", he said, \"these boys' marks are really that well?\"", "C:/nl-token.bin", "word");
		} catch (IOException e) {
		}
	}
